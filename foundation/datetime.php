 ...
 * @return bool|string
 */
function datetime_getMonday($timestamp)
{
 ...
 * @return bool|string
 */
function datetime_getQuarterFirstMonth($timestamp)
{
    $m = date('m', $timestamp);
    switch ($m) {
        case 1:
 ...
 * @return bool|string
 */
function datetime_getQuarterLastMonth($timestamp)
{
    $m = date('m', $timestamp);
    switch ($m) {
        case 1:
 ...
 * @return string | array
 */
function datetime_strtomicrotime($str, $isFloat = false, $deep = 6)
{
    $micros = explode('.', $str);
 ...
 * @return string
 */
function datetime_datemicro($format, $val)
{
    $micros = datetime_strtomicrotime($val);
